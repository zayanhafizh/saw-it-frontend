        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-cyan-50 to-cyan-100 hover:scale-105">
            ...
            <CardContent>
              ...
              <p className="text-xs md:text-sm text-gray-600">Penyegaran terjadwal</p>
              <div className="mt-2 flex items-center gap-1 text-cyan-600">
                <AlertCircle className="h-3 w-3" />
                <span className="text-xs font-medium">Pembaruan otomatis aktif</span>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <CardDescription className="text-sm mt-1">
                  Filter dan cari estimasi produksi berdasarkan berbagai kriteria
                </CardDescription>
              </div>
