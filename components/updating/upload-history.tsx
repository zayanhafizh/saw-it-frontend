...
const getStatusBadge = (status: string) => {
  switch (status) {
    case "success":
      return <Badge className="bg-emerald-100 text-emerald-800 border-emerald-200">Berhasil</Badge>
    case "processing":
      return <Badge className="bg-blue-100 text-blue-800 border-blue-200">Memproses</Badge>
    case "error":
  ...
  return (
    <Card className="border-emerald-200">
      <CardHeader>
        ...
        <CardDescription>Unggahan data terbaru dan status pemrosesannya</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-emerald-50">
                <TableHead className="font-semibold text-emerald-800">Nama File</TableHead>
                <TableHead className="font-semibold text-emerald-800">Jenis Data</TableHead>
                <TableHead className="font-semibold text-emerald-800">Tanggal Unggah</TableHead>
                <TableHead className="font-semibold text-emerald-800">Status</TableHead>
                <TableHead className="font-semibold text-emerald-800">Catatan</TableHead>
                <TableHead className="font-semibold text-emerald-800">Ukuran</TableHead>
                <TableHead className="font-semibold text-emerald-800">Diunggah Oleh</TableHead>
